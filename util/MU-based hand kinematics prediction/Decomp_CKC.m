function vResult_CKC = Decomp_CKC(vEMG, vChannelSpatial)
...
vEMG_2D = OutlierDetection_OutlierValue(EMGReshape_1DTo2D(vEMG,vChannelSpatial),16,[]);
[vEMG_2D,~] = OutlierDetection_OutlierChannel_PautaCriterion(vEMG_2D,0.85);
vEMG_1D = EMGReshape_2DTo1D(vEMG_2D,vChannelSpatial);
