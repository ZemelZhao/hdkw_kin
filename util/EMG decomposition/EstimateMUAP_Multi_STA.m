function vMUAPList = EstimateMUAP_Multi_STA(vEMG, vSpikeIndexList, iMUAPLength)
...
for iMUIndex = 1:iMUNum
    ...
    for iRowIndex=1:iRowNum
        for iColIndex=1:iColNum
            vMUAP{iRowIndex,iColIndex}=vH_Single(iChannelIndex,:)/length(vSpikeIndexList{1,iMUIndex});
